...
valuelist = []
# for the small CSV i = 3. so iterates for each nucleotide.
for q in range(len(i)):
    ...
    while position < len(data):
        ...
        # i.e not found, reset the counter, stop the loop.
        if position == -1:
            counter = 0
            break
...
# compare valuelist to reader and if found print the name of the person whos DNA has all the occurances to the terminal.
